...
function createModel() {
    ...
    const setData = (data,product=null) => {
        // Object validation
        if (!data) return null;
        ...
        if (!product) {    // Calculating ID
            ...
            id = Number(localStorage.getItem('selectedProductID'));
            const productIndex = currentData.findIndex((singleProduct) => singleProduct.id === id );
            const dataToSave = {...data, id};
            currentData[productIndex] = dataToSave;
        }
